import BadCallOutComponent, {
  CallOutComponent,
} from "@/components/base/CallOutComponent";
    ...
    <>
      ...
      <div className="prose prose-neutral dark:prose-invert">
        ...
        <p className="job-description">
          ...
          applications and services range from older technologies such as BASIC
          to .NET 4.2 to modern technologies such as React and Next.js.
        </p>
        <p>
          My primary objective is to help develop and scale a variety of NPM
          packages that help support DTN developers. These NPM packages range
          from a component library (built in{" "}
        ...
        <ul className="list-disc list-outside">
          ...
          <li>
            <p>
              At the end of 2022 and start of 2023, my responsibilities grew and
              I began to wear multiple hats. 🕵🏼‍♂️ 🧙🏼‍♂️ 👨🏼‍🚒 👨🏼‍🌾 👨🏼‍🍳 💂🏼‍♂️
            </p>
            <p>
            ...
            <p>
              ...
              and publishing was a manual step. It was costly, it could take up
              to a morning for us to release and deploy to our Dev, Staging, and
              Production environments. The solution was to make this process
              part of our CI/CD pipeline in Gitlab. We utilized{" "}
              <SpecialAnchor
              ...
              />{" "}
              so when our team merged Pull Requests, our CI/CD would kick off
              and publish a release candidate. This gave our QA and the DTN
              Developers a way to test new features, bug fixes without any major
              impacts. If the issue persists, developers can revert back to
              production. At the end of a Sprint, we would publish our
              production versions of our packages.
            </p>
          </li>
          ...
          <li>
            <p>
              ...
              wanted to replicate the success of our monorepo and NPM packages
              but there were caveats. Widgets needed to be both an NPM package
              but, also have have the capability to import the Widget through an
              Javascript file.
            </p>
            ...
            <p>
              ...
              `tsconfig.json` for NPM packages and the necessary command would
              call our `tsconfig.esm.json` for creating our Javascript files.
            </p>
          </li>
        </ul>
      </div>
