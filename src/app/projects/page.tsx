        ...
        >
          <li className="group relative flex flex-col items-start">
            ...
            <h2 className="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
              ...
              <a href="https://tc.rudypenajr.com/" target="_blank">
          ...
          <li className="group relative flex flex-col items-start">
            <div className="relative z-10 flex h-12 w-12 items-center justify-center rounded-full bg-white ring-1 shadow-md shadow-zinc-800/5 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
              <Image
                alt=""
                src="/music_3917683.png" // Ensure this path is correct and in the `public` folder or use an absolute URL
                width={32}
                height={32}
            ...
            <h2 className="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
              <div className="absolute -inset-x-4 -inset-y-6 z-0 scale-95 bg-zinc-50 opacity-0 transition group-hover:scale-100 group-hover:opacity-100 sm:-inset-x-6 sm:rounded-2xl dark:bg-zinc-800/50"></div>
              <a href="https://playlist.rudypenajr.com/" target="_blank">
                <span className="absolute -inset-x-4 -inset-y-6 z-20 sm:-inset-x-6 sm:rounded-2xl"></span>
                <span className="relative z-10">Playlists</span>
              </a>
            </h2>
            <p className="leading-6 relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
              Love live music? Me too. This app scans an artist’s last five
              setlists on setlist.fm and generates a playlist—powered by Next.js
              and OpenAI.
            </p>
            <p className="relative z-10 mt-6 flex text-sm font-medium text-zinc-400 transition group-hover:text-teal-500 dark:text-zinc-200">
              <svg
              ...
              <span className="ml-2">playlist.rudypenajr.com/</span>
            </p>
          </li>
        </ul>
      </div>
